...
public final class FragmentLogInBinding implements ViewBinding {
  ...
  private FragmentLogInBinding(@NonNull LinearLayout rootView, @NonNull EditText email,
      @NonNull TextView forgotYourPassword, @NonNull Button loginButton, @NonNull EditText password,
  ...
  public static FragmentLogInBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLogInBinding((LinearLayout) rootView, email, forgotYourPassword,
          loginButton, password, signUp);
    }
